...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = (function (_super) {
	    ...
	    Game.prototype._initNextBlocks = function () {
	        var _a = this._options, cellWidth = _a.cellWidth, nextBlockCount = _a.nextBlockCount;
	        this._nextBlocks = new NextBlocks_1.default(nextBlockCount, cellWidth);
	    ...
	    Game.prototype._initInfoPanel = function () {
	        this._infoPanel = new Infos_1.default(this._options.cellWidth / 2);
	    ...
	    Game.prototype._nextRound = function (fallDown) {
	        ...
	        this.wait(this.msToFrames(ms), false, function () {
	            ...
	            if (rows.length) {
	                ...
	                _this._infoPanel.rows = _this._record.clearLines;
	                _this._infoPanel.score = _this._record.score;
	                if (_this._record.clearLines >= (_this.level + 1) * 30) {
	                    _this.level++;
	                }
	            }
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = (function (_super) {
	    ...
	    Board.prototype._updateMapView = function () {
	        var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NextBlocks = (function (_super) {
	    ...
	    NextBlocks.prototype.hideBlocks = function () {
	        _.forEach(this._blockBoards, function (b) {
	            b.hideBlock();
	        });
	        return this;
	    };
	    NextBlocks.prototype.showBlocks = function () {
	        _.forEach(this._blockBoards, function (b) {
	            b.showBlock();
	        });
	        return this;
	    };
	    NextBlocks.prototype.refreshBlocks = function () {
	        _.forEach(this._blockBoards, function (b) {
	            b.changeRandom();
	        });
	        return this;
...
/***/ function(module, exports) {
	...
	var Infos = (function (_super) {
	    ...
	    Object.defineProperty(Infos.prototype, "level", {
	        get: function () {
	            return this._level;
	        },
	        set: function (lv) {
	    ...
	    Object.defineProperty(Infos.prototype, "rows", {
	        get: function () {
	            return this._rows;
	        },
	    ...
	    Object.defineProperty(Infos.prototype, "score", {
	        get: function () {
	            return this._rows;
	        },
	    ...
	    Infos.prototype._initScore = function (fontsize) {
	    ...
	    Infos.prototype._update = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyController = (function () {
	    function KeyController(_dom, onKeydown, interval, firstIntervalRatio, _enabled) {
	        ...
	        if (interval === void 0) { interval = 80; }
