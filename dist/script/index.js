...
/***/ function(module, exports, __webpack_require__) {
	...
	var board = new Board_1.default(config_1.default.CELL_WIDTH);
	board.y = config_1.default.CELL_WIDTH;
	board.x = config_1.default.CELL_WIDTH * 4;
	stage_1.default.addChild(board);
	var activeBlock = new Block_1.default(config_1.default.CELL_WIDTH);
	...
	var keyController = new KeyController_1.default(stage_1.canvas);
